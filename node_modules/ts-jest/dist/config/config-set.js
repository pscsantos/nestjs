...
var ConfigSet = (function () {
    function ConfigSet(_jestConfig, parentOptions, parentLogger) {
        var _a;
        this._jestConfig = _jestConfig;
    ...
    Object.defineProperty(ConfigSet.prototype, "raiseDiagnostics", {
        get: function () {
            var _this = this;
            var _a = this, createTsError = _a.createTsError, filterDiagnostics = _a.filterDiagnostics, throws = _a.tsJest.diagnostics.throws;
    ...
    Object.defineProperty(ConfigSet.prototype, "hooks", {
        get: function () {
            ...
            if (hooksFile) {
                ...
                return importer_1.importer.tryThese(hooksFile) || {};
            }
            return {};
        },
        enumerable: true,
    ...
    Object.defineProperty(ConfigSet.prototype, "tsCacheDir", {
        get: function () {
            ...
            var res = path_1.join(this.jest.cacheDirectory, "ts-jest-" + cacheSuffix);
    ...
    ConfigSet.prototype.readTsConfig = function (compilerOptions, resolvedConfigFile, noProject) {
        ...
        config.compilerOptions = __assign({}, DEFAULT_COMPILER_OPTIONS, config.compilerOptions, compilerOptions, FORCE_COMPILER_OPTIONS);
        ...
        for (var key in FORCE_COMPILER_OPTIONS) {
            if (FORCE_COMPILER_OPTIONS[key] === undefined) {
